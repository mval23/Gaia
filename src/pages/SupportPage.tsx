  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <MonetAccent className={styles.accent} art="cliff" variant="strip" fill phrase="slow is still moving" />
      </header>
      ...
      <div className={styles.tiers}>
        ...
        <section className={`${styles.tier} ${styles.weeks}`} aria-labelledby="tier-weeks">
          ...
          <p className={styles.tierWhen}>
            Any of these is reason enough to talk to a doctor or a mental-health professional.
          </p>
      ...
      <p className={styles.footNote}>
        Your planner stays on this device. Gaia only sends a linked group's task times to your Outlook calendar, and never reads your
        reflections.
      </p>
    </div>
  );
